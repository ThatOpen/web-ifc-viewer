// lib/web-ifc.js
var WebIFCWasm = function() {
  var _scriptDir = import.meta.url;
  return function(WebIFCWasm2) {
    WebIFCWasm2 = WebIFCWasm2 || {};
    var Module = typeof WebIFCWasm2 !== "undefined" ? WebIFCWasm2 : {};
    ...
    noExitRuntime = true;
    run();
    return WebIFCWasm2.ready;
  };
}();
var web_ifc_default = WebIFCWasm;
...
var IfcAPI = class {
  ...
  async Init() {
    if (web_ifc_default) {
      this.wasmModule = await web_ifc_default({noInitialRun: true});
    } else {
