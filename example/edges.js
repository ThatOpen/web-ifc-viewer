import { EdgesGeometry, MeshBasicMaterial, LineBasicMaterial, LineSegments, DoubleSide, ShaderMaterial } from 'three';
import { LineSegmentsGeometry } from 'three/examples/jsm/lines/LineSegmentsGeometry';
import { LineSegments2 } from 'three/examples/jsm/lines/LineSegments2';
import { LineMaterial } from 'three/examples/jsm/lines/linematerial';
import {ConditionalEdgesGeometry} from './conditional-lines/ConditionalEdgesGeometry';
import {ConditionalEdgesShader} from './conditional-lines/ConditionalEdgesShader';
...
export function updateModel(model, scene) {
  ...
  initConditionalModel(model, scene);
...
function initConditionalModel(model, scene) {

  const geom = model.geometry.toNonIndexed();
