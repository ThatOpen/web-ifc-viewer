...
(function () {
  ...
  THREE.OOrbitControls = function (object, domElement) {
    ...
    function onMouseWheel(event) {
      ...
      if (constraint.smoothZoom !== false) {
        if (event.wheelDelta) {
        ...
        constraint.zoomStart += delta * 0.001;
      } else {
  ...
  THREE.OOrbitControls.prototype = Object.create(THREE.EventDispatcher.prototype);
  THREE.OOrbitControls.prototype.constructor = THREE.OOrbitControls;

  Object.defineProperties(THREE.OOrbitControls.prototype, {
    object: {
      get: function () {
